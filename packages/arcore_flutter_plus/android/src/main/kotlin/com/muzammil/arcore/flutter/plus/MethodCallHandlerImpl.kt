...
import com.muzammil.arcore.flutter.plus.RenderableCustomFactory
...
class MethodCallHandlerImpl(private val activity: Activity, private val messenger: BinaryMessenger) : MethodChannel.MethodCallHandler {
    ...
    private val UTILS_CHANNEL_NAME = "arcore_flutter_plus/utils"
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        when (call.method) {
            ...
            "prefetchReferenceModel" -> {
                ...
                RenderableCustomFactory.prefetchReferenceModel(
